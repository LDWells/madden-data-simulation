...
def parse_query(args):
    parser = ArgumentParser(description="Queries a team standing for the specified team in the specified dataset.")
...
def parse_compare(args):
    parser = ArgumentParser(description="Compares a stat for a team between one or more datasets, " +
                                        "outputting to a graph.")
